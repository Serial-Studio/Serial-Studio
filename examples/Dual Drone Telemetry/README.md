...
|-------|------|---------------|----------|-------------|
| **Alpha** | 9001 | Circular patrol (~330 m radius) | 120 m | Top-down terrain with targeting reticle |
| **Bravo** | 9002 | Figure-8 survey (~550 m radius) | 200 m | Thermal/IR heat map with scan grid |

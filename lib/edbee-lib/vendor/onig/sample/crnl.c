...
static void result(int no, int from, int to, int expected_from, int expected_to)
{
...
static int x0(int no, char *pattern_arg, char *str_arg, int start_offset,
              int expected_from, int expected_to, int backward)
{
  int r;
  ...
  r = onig_new(&reg, pattern, pattern + strlen((char *)pattern),
               ONIG_OPTION_NEWLINE_CRLF, ONIG_ENCODING_UTF8,
...
static int f0(int no, char *pattern_arg, char *str_arg, int start_offset,
              int backward)
{
...
extern int main(int argc, char *argv[])
{
  ...
  /*  x0(67, "^a",     "\r\na",  -1,  2,  3,  1); */
  f0(67, "^a", "\r\na", -1,
     1); /* This should not match after the fix of Issue #22. */
  f0(68, "^a", "\r\na", -2, 1);

...
static void xx(char *pattern, char *str, int from, int to, int mem, int not)
{
    ...
    else
    {
      ...
      else
      {
        fprintf(stdout, "FAIL: /%s/ '%s' %d-%d : %d-%d\n", pattern, str,
                (int)from, (int)to, (int)pmatch[mem].rm_so,
                (int)pmatch[mem].rm_eo);
        nfail++;
      }
    }
  }
  ...
  else
  {
    ...
    else
    {
      ...
      {
        fprintf(stdout, "FAIL: /%s/ '%s' %d-%d : %d-%d\n", pattern, str,
                (int)from, (int)to, (int)region->beg[mem],
                (int)region->end[mem]);
        nfail++;
      }
    }
...
extern int main(int argc, char *argv[])
{
  ...
  x2("Ç§Ç§", "Ç§Ç§", 0, 4);
  x2("Ç†Ç¢Ç§", "Ç†Ç¢Ç§", 0, 6);
  x2("Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±Ç±",
  ...
  x2("Ç†|Ç¢|Ç§", "Ç¶Ç§", 2, 4);
  x2("Ç†|Ç¢|Ç§Ç¶|Ç®Ç©Ç´|Ç≠|ÇØÇ±Ç≥|ÇµÇ∑Çπ|Çª|ÇΩÇø|Ç¬ÇƒÇ∆Ç»Ç…|Ç ÇÀ", "ÇµÇ∑Çπ", 0,
     6);
  ...
  x2("\\A(?:\\g<à¢_1>|\\g<â]_2>|\\zèIóπ  "
     "(?<à¢_1>äœ|é©\\g<â]_2>é©)(?<â]_2>ç›|ïÏéF\\g<à¢_1>ïÏéF))$",
     "ïÏéFé©ïÏéFé©ç›é©ïÏéFé©ïÏéF", 0, 26);
  x2("[[Ç–Ç”]]", "Ç”", 0, 2);
  x2("[[Ç¢Ç®Ç§]Ç©]", "Ç©", 0, 2);
  n("[[^Ç†]]", "Ç†");
  n("[^[Ç†]]", "Ç†");
  ...
  x2("a<b>ÉoÅ[ÉWÉáÉìÇÃÉ_ÉEÉìÉçÅ[Éh<\\/b>", "a<b>ÉoÅ[ÉWÉáÉìÇÃÉ_ÉEÉìÉçÅ[Éh</b>",
     0, 32);
  x2(".<b>ÉoÅ[ÉWÉáÉìÇÃÉ_ÉEÉìÉçÅ[Éh<\\/b>", "a<b>ÉoÅ[ÉWÉáÉìÇÃÉ_ÉEÉìÉçÅ[Éh</b>",
     0, 32);
  fprintf(stdout,

...
/// Converst all tabs to sapces of the given string, using the current
/// tab/indent settings It converts "\t" to spaces.
///
...
/// @return a vector with the character-offset in the given string that contains
/// the given tab-column

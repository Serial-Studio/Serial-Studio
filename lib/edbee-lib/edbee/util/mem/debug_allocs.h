...
/// Original source from: http://www.gilgil.net by Gilbert Lee. All rights
/// reserved Altered to use QT API
#pragma once
...
struct DebugAllocation
{
  ...
  //    MemoryLeakInfo( void *p1, std::size_t size1, char *file1, int line1) :
  //    p(p1), size(size1), file(file1), line(line1) {}
  void clear()
  {
    pointer = 0;
    size = 0;

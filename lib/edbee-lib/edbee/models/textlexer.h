...
public:
  ...
  /// WARNING, this method must be VERY optimized and should 'remember' the
  /// lexing states between calls. To invalidate the scopes/lexing state the
  /// textReplaced method can be used
  ///

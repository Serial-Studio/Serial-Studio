...
private:
  TextRangeSet
      *rangeSet_; ///< This rangeset contains the new ranges OR the old ranges,
                  ///< depending on the state on the undo-stack (This is scary
                  ///< but saves us the storage of a compelte rangeSet)
};

...
/// A single text-change with an extra offset which represents the location of
/// the caret. Currently this class is passed a TextDocumentFilter which enables
/// it to alter the caret position I'm in doubt if we really need to implement
/// it this way.

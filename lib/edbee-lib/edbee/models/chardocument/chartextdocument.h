...
protected slots:
  //    virtual void textReplaced( int offset, int length, const QChar* data,
  //    int dataLength ); virtual void linesReplaced( int line, int lineCount,
  //    int newLineCount );
...
private:
  ...
  TextAutoCompleteProviderList
      *autoCompleteProviderList_; ///< The Auto Complete Provide list
};

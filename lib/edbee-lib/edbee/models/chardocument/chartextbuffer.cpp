...
void CharTextBuffer::replaceText(int offset, int length, const QChar *buffer,
                                 int bufferLength)
{
  ...
  //    emit linesAboutToBeReplaced( change.line, change.lineCount,
  //    change.newLineCount );
...
void CharTextBuffer::rawAppendEnd()
{
  ...
  */
  ...
  TextBufferChange change(this, rawAppendStart_, 0,
                          buf_.data() + rawAppendStart_,
                          buf_.length() - rawAppendStart_);
...
/// WARNING calling this method moves the gap of the gapvector to the end. Which
/// could involve a lot of data moving

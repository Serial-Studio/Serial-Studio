...
private:
  TextScopeSelector
      *selector_; ///< The selector that matches this dynamic variable
};

//--------------------------------

/// This class is used for remembering/managing dynamic variables
/// This are a kind of environment variables that are dependent on the given
/// context
...
public:
  ...
  void setAndGiveScopedSelector(const QString &name, const QVariant &value,
...
private:
  ...
  QMap<QString, BasicDynamicVariable *>
      variableMap_; ///< The static variable map
  QMultiMap<QString, ScopedDynamicVariable *>
      scopedVariableMap_; ///< A map with all scoped variables.
};

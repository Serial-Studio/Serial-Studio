...
public:
  ...
  QString findBySequence(QKeySequence sequence,
                         QKeySequence::SequenceMatch &match);

  static QKeySequence joinKeySequences(const QKeySequence seq1,
...
private:
  ...
  QMultiHash<QString, TextEditorKey *>
      keyMap_; ///< a map to convert a name to a
};
...
private:
  QHash<QString, TextEditorKeyMap *>
      keyMapHash_; ///< All loaded keymaps identified by name
};

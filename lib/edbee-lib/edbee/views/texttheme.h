...
{
public:
  TextThemeRule(const QString &name, const QString &selector,
...
public:
  ...
  void fillFormatForTextScopeList(const TextScopeList *scopeList,
...
private:
  ...
  // thTheme settings
  QColor backgroundColor_; ///< The default background color
                           ///< <key>background</key> <string>#272822</string>
  QColor caretColor_;      ///< The default caret color         <key>caret</key>
                           ///< <string>#F8F8F0</string>
  QColor foregroundColor_; ///< The default foreground color
                           ///< <key>foreground</key> <string>#F8F8F2</string>
  QColor invisiblesColor_; ///< The invisible color <key>invisibles</key>
                           ///< <string>#3B3A32</string>
  QColor lineHighlightColor_; ///< The highlight color <key>lineHighlight</key>
                              ///< <string>#3E3D32</string>
  QColor selectionColor_; ///< The selection color <key>selection</key>
                          ///< <string>#49483E</string>
  QColor findHighlightBackgroundColor_; ///< The find-highlight color
                                        ///< <key>findHighlight</key>
                                        ///< <string>#FFE792</string>
  QColor findHighlightForegroundColor_; ///< The find-highlight color
                                        ///< <key>findHighlightForeground</key>
                                        ///< <string>#000000</string>
  QColor selectionBorderColor_;         ///< The selection border color
                                        ///< <key>selectionBorder</key>
                                        ///< <string>#222218</string>
  QColor activeGuideColor_; ///< The active guide color <key>activeGuide</key>
                            ///< <string>#9D550FB0</string>

  QColor bracketForegroundColor_; ///< The bracket foreground color
                                  ///< <key>bracketsForeground</key>
                                  ///< <string>#F8F8F2A5</string>
  QString bracketOptions_; ///< The bracket options <key>bracketsOptions</key>
                           ///< <string>underline</string>

  QColor bracketContentsForegroundColor_; ///< The content foreground color
                                          ///< <key>bracketContentsForeground</key>
                                          ///< <string>#F8F8F2A5</string>
  QString bracketContentsOptions_; ///< The bracket options
                                   ///< <key>bracketContentsOptions</key>
                                   ///< <string>underline</string>

  QString tagsOptions_; ///< The tags options <key>tagsOptions</key>
...
private:
  ...
  void appendFormatRange(QVector<QTextLayout::FormatRange> &rangeList,
                         int start, int end,
                         QVector<edbee::ScopedTextRange *> &activeRanges);

private slots:

  void textDocumentChanged(edbee::TextDocument *oldDocument,
                           edbee::TextDocument *newDocument);
  void invalidateLayouts();
  void themePointerChanged(const QString &name, TextTheme *oldTheme,
                           TextTheme *newTheme);

private:
  TextEditorController *controllerRef_; ///< A reference to the controller
  QString themeName_;   ///< The name of the active theme (when a 'custom' theme
                        ///< active)
...
public:
  ...
  TextTheme *readThemeFile(const QString &fileName,
...
private:
  ...
  TextTheme *fallbackTheme_; ///< The fallback theme (this can be used if no
                             ///< themes are found)

...
/// TODO: Currently this class is also used for positioning text. This probably
/// should be moved in a class of its own
...
private:
  TextEditorController
      *controllerRef_; ///< A reference to the widget it is rendering
  qint64 caretTime_; ///< The current time of the caret. -1 means that the caret
                     ///< is disabled
  qint64 caretBlinkRate_; ///< The caret blink rate

  QCache<int, TextLayout>
      cachedTextLayoutList_; ///< A list of cached text layouts

  QRect viewport_; ///< The current (total) viewport. (This is updated from the
                   ///< window)

...
class EDBEE_EXPORT TextEditorComponent : public QWidget
{
  Q_OBJECT
public:
  explicit TextEditorComponent(TextEditorController *controller,
                               QWidget *parent = 0);
...
private:
  ...
  QString lastCharacter_; ///< The last added character. (for undo-group per
                          ///< space support)
  ...
  TextRange clickRange_;  ///< The initial click range (to keep the first
                          ///< word/line selected)

...
/// You can override the methods in the class for adding functionality to the
/// text-margin component
...
public:
  ...
  virtual void renderBefore(QPainter *painter, int startLine, int endLine,
                            int width);
  virtual void renderAfter(QPainter *painter, int startLine, int endLine,
                           int width);
  ...
  {
    marginComponentRef_ = comp;
  }

private:
  TextMarginComponent
      *marginComponentRef_; ///< A reference to the margincomponent
...
protected:
  ...
  virtual void renderCaretMarkers(QPainter *painter, int startLine, int endLine,
                                  int width);
  virtual void renderLineNumber(QPainter *painter, int startLine, int endLine,
                                int width);

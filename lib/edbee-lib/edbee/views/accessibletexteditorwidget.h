...
class EDBEE_EXPORT AccessibleTextEditorWidget : public QAccessibleWidget,
...
public:
  static QAccessibleInterface *factory(const QString &className,
                                       QObject *object);
  static QWidget *eventWidgetForTextEditor(TextEditorWidget *widget);

  static void notifyTextSelectionEvent(TextEditorWidget *widget,
                                       TextSelection *selection);
  static void notifyTextChangeEvent(TextEditorWidget *widget,
                                    TextBufferChange *change, QString oldText);
...
public:
  virtual void selection(int selectionIndex, int *startOffset,
  ...
  virtual void setSelection(int selectionIndex, int startOffset,
  ...
  virtual QString attributes(int offset, int *startOffset,
                             int *endOffset) const override;

  virtual QString textAfterOffset(int offset,
                                  QAccessible::TextBoundaryType boundaryType,
                                  int *startOffset,
                                  int *endOffset) const override;
  virtual QString textAtOffset(int offset,
                               QAccessible::TextBoundaryType boundaryType,
                               int *startOffset, int *endOffset) const override;
  virtual QString textBeforeOffset(int offset,
                                   QAccessible::TextBoundaryType boundaryType,
                                   int *startOffset,
                                   int *endOffset) const override;

...
class QWT_EXPORT QwtPlot : public QFrame, public QwtPlotDict
{
  ...
  Q_PROPERTY(
      QBrush canvasBackground READ canvasBackground WRITE setCanvasBackground)
...
public:
  ...
  void enableAxis(int axisId, bool on = true) { setAxisVisible(axisId, on); }

  bool axisEnabled(int axisId) const { return isAxisVisible(axisId); }
#endif

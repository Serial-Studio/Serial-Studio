 ...
 */
void QwtPlotMarker::draw(QPainter *painter, const QwtScaleMap &xMap,
 ...
 */
void QwtPlotMarker::drawLines(QPainter *painter, const QRectF &canvasRect,
 ...
 */
void QwtPlotMarker::drawSymbol(QPainter *painter, const QRectF &canvasRect,
                               const QPointF &pos) const
{
  ...
  if (symbol.style() != QwtSymbol::NoSymbol)
  {
    ...
    const QRectF clipRect = canvasRect.adjusted(-sz.width(), -sz.height(),
                                                sz.width(), sz.height());
...
/*!
   ...
   \sa drawLabel(), drawSymbol()
 */
void QwtPlotMarker::drawLabel(QPainter *painter, const QRectF &canvasRect,
                              const QPointF &pos) const
{
...
/*!
   ...
   \sa pen(), brush()
 */
void QwtPlotMarker::setLinePen(const QColor &color, qreal width,
                               Qt::PenStyle style)
{

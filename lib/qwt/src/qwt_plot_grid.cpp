...
/*!
   ...
   \sa pen(), brush()
 */
void QwtPlotGrid::setMajorPen(const QColor &color, qreal width,
                              Qt::PenStyle style)
{
...
/*!
   ...
   \sa pen(), brush()
 */
void QwtPlotGrid::setMinorPen(const QColor &color, qreal width,
                              Qt::PenStyle style)
{
 ...
 */
void QwtPlotGrid::draw(QPainter *painter, const QwtScaleMap &xMap,

...
static QPainterPath qwtTransformPath(const QwtScaleMap &xMap,
                                     ...
                                     const QPainterPath &path, bool doAlign)
{
  QPainterPath shape;
...
/*!
   ...
   \sa pen(), brush()
 */
void QwtPlotShapeItem::setPen(const QColor &color, qreal width,
                              Qt::PenStyle style)
{
 ...
 */
void QwtPlotShapeItem::draw(QPainter *painter, const QwtScaleMap &xMap,
                            const QwtScaleMap &yMap,

...
/*!
   ...
   regions, rectangles, ellipses or irregular areas defined by lines, and
   curves. QwtPlotShapeItem displays a shape with a pen and brush.
   ...
   More complex shapes, that can't be expressed by a QPainterPath can be
   displayed using QwtPlotGraphicItem.

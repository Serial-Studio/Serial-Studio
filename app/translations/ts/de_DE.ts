...
--
        ...
        <translation>--
-- Definieren Sie eine Transformationsfunktion transform(value), die den Live-Datensatzwert empfängt und eine transformierte Zahl zurückgibt. Wenn keine Transformationsfunktion transform() definiert ist, wird der Rohwert beibehalten und nichts mit dem Projekt gespeichert.
--
-- Beispiel:
--    function transform(value)
--      return value * 0.01 + 273.15
--    end
--
-- Global deklarierte Variablen auf oberster Ebene bleiben zwischen den Frames bestehen, was nützlich für Filter, Akkumulatoren und andere zustandsbehaftete Transformationen ist, genau wie ein Frame-Parser-Skript:
--
--    local alpha = 0.1
--    local ema
--
...
--    end
--
-- Verwenden Sie das Dropdown-Menü Vorlage für fertige Beispiele oder klicken Sie auf Testen, um Ihre Funktion auszuprobieren.
--
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Analysiere über JSON-Projektdatei</translation>
    </message>
    <message>

...
static QString buildRoleBlock(bool device_control, bool memory_on, bool probe_on)
{
  ...
  return QStringLiteral(
           ...
           "only -- transforms and canvas scripts stay JS/Lua.\n"
           ...
           "Prefer computed datasets over baking derivations into the parser -- "
           "they're testable via dryRun, can read peers across sources, and "
           "carry their own units/ranges/alarms.\n"
           "  Variable types -> project.dataTable.get returns each variable's "
           "type (Computed vs Constant) in the response. Computed variables "
           ...
           "on an unknown table or variable returns nil/empty AND logs a "

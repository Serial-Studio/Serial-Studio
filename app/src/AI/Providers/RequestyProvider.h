...
/**
 * @brief Requesty adapter on top of the OpenAI-compatible Chat Completions transport.
 */
class RequestyProvider : public Provider {
public:
  RequestyProvider(QNetworkAccessManager& nam, std::function<QString()> keyGetter);

...
private:
  ...
  static CommandResponse setHostname(const QString &id,
                                     const QJsonObject &params);
  static CommandResponse setPort(const QString &id, const QJsonObject &params);
  static CommandResponse setClientId(const QString &id,
                                     const QJsonObject &params);
  static CommandResponse setUsername(const QString &id,
                                     const QJsonObject &params);
  static CommandResponse setPassword(const QString &id,
                                     const QJsonObject &params);
  static CommandResponse setTopic(const QString &id, const QJsonObject &params);
  static CommandResponse setCleanSession(const QString &id,
                                         const QJsonObject &params);
  static CommandResponse setMqttVersion(const QString &id,
                                        const QJsonObject &params);
  static CommandResponse setKeepAlive(const QString &id,
                                      const QJsonObject &params);
  static CommandResponse setAutoKeepAlive(const QString &id,
                                          const QJsonObject &params);
  static CommandResponse setWillQoS(const QString &id,
                                    const QJsonObject &params);
  static CommandResponse setWillRetain(const QString &id,
                                       const QJsonObject &params);
  static CommandResponse setWillTopic(const QString &id,
                                      const QJsonObject &params);
  static CommandResponse setWillMessage(const QString &id,
                                        const QJsonObject &params);
  static CommandResponse setSslEnabled(const QString &id,
                                       const QJsonObject &params);
  static CommandResponse setSslProtocol(const QString &id,
                                        const QJsonObject &params);
  static CommandResponse setPeerVerifyMode(const QString &id,
                                           const QJsonObject &params);
  static CommandResponse setPeerVerifyDepth(const QString &id,
                                            const QJsonObject &params);
  ...
  static CommandResponse disconnect(const QString &id,
                                    const QJsonObject &params);
  static CommandResponse toggleConnection(const QString &id,
                                          const QJsonObject &params);
  static CommandResponse regenerateClientId(const QString &id,
                                            const QJsonObject &params);

  // Query commands
  static CommandResponse getConfiguration(const QString &id,
                                          const QJsonObject &params);
  static CommandResponse getConnectionStatus(const QString &id,
                                             const QJsonObject &params);
  static CommandResponse getModes(const QString &id, const QJsonObject &params);
  static CommandResponse getMqttVersions(const QString &id,
                                         const QJsonObject &params);
  static CommandResponse getSslProtocols(const QString &id,
                                         const QJsonObject &params);
  static CommandResponse getPeerVerifyModes(const QString &id,
                                            const QJsonObject &params);
};

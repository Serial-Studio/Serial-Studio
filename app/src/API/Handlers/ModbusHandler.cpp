...
void API::Handlers::ModbusHandler::registerCommands()
{
  ...
  registry.registerCommand(
      ...
      QStringLiteral(
          "Set Modbus protocol (params: protocolIndex - 0=RTU, 1=TCP)"),
      &setProtocolIndex);

  registry.registerCommand(
      QStringLiteral("io.driver.modbus.setSlaveAddress"),
  ...
  registry.registerCommand(
      ...
      QStringLiteral(
          "Set polling interval in milliseconds (params: intervalMs)"),
      &setPollInterval);
  ...
  registry.registerCommand(
      QStringLiteral("io.driver.modbus.setSerialPortIndex"),
      QStringLiteral("Set RTU serial port by index (params: portIndex)"),
      &setSerialPortIndex);

  registry.registerCommand(
      QStringLiteral("io.driver.modbus.setBaudRate"),
      QStringLiteral("Set RTU baud rate (params: baudRate)"), &setBaudRate);

  registry.registerCommand(
      QStringLiteral("io.driver.modbus.setParityIndex"),
      QStringLiteral("Set RTU parity (params: parityIndex)"), &setParityIndex);

  registry.registerCommand(
      QStringLiteral("io.driver.modbus.setDataBitsIndex"),
      QStringLiteral("Set RTU data bits (params: dataBitsIndex)"),
      &setDataBitsIndex);

  registry.registerCommand(
      QStringLiteral("io.driver.modbus.setStopBitsIndex"),
  ...
  registry.registerCommand(
      QStringLiteral("io.driver.modbus.removeRegisterGroup"),
      QStringLiteral("Remove register group by index (params: groupIndex)"),
      &removeRegisterGroup);

  registry.registerCommand(
      QStringLiteral("io.driver.modbus.clearRegisterGroups"),
      QStringLiteral("Clear all register groups"), &clearRegisterGroups);
  ...
  registry.registerCommand(
      QStringLiteral("io.driver.modbus.getRegisterTypeList"),
      QStringLiteral("Get list of register type names"), &getRegisterTypeList);
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setProtocolIndex(const QString &id,
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setSlaveAddress(const QString &id,
                                              const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("address")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: address"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setPollInterval(const QString &id,
                                              const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("intervalMs")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: intervalMs"));
  }
  ...
  if (intervalMs < 10)
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("intervalMs must be at least 10 milliseconds"));
  }

  IO::Drivers::Modbus::instance().setPollInterval(
      static_cast<quint16>(intervalMs));
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setHost(const QString &id,
                                      const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setPort(const QString &id,
                                      const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setSerialPortIndex(const QString &id,
                                                 const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("portIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: portIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setBaudRate(const QString &id,
                                          const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("baudRate")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: baudRate"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setParityIndex(const QString &id,
                                             const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("parityIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: parityIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setDataBitsIndex(const QString &id,
                                               const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("dataBitsIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: dataBitsIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::setStopBitsIndex(const QString &id,
                                               const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("stopBitsIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: stopBitsIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::addRegisterGroup(const QString &id,
                                               const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("type"))
      || !params.contains(QStringLiteral("startAddress"))
      || !params.contains(QStringLiteral("count")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral(
            "Missing required parameters: type, startAddress, count"));
  }
  ...
  if (startAddress < 0 || startAddress > 65535)
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("Invalid startAddress: %1. Valid range: 0-65535")
            .arg(startAddress));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::removeRegisterGroup(const QString &id,
                                                  const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("groupIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: groupIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::clearRegisterGroups(const QString &id,
                                                  const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getConfiguration(const QString &id,
                                               const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  if (modbus.protocolIndex() < protocolList.count())
    result[QStringLiteral("protocolName")]
        = protocolList.at(modbus.protocolIndex());
  ...
  if (modbus.serialPortIndex() < portList.count())
    result[QStringLiteral("serialPortName")]
        = portList.at(modbus.serialPortIndex());
  ...
  if (modbus.dataBitsIndex() < dataBitsList.count())
    result[QStringLiteral("dataBitsValue")]
        = dataBitsList.at(modbus.dataBitsIndex());
  ...
  if (modbus.stopBitsIndex() < stopBitsList.count())
    result[QStringLiteral("stopBitsValue")]
        = stopBitsList.at(modbus.stopBitsIndex());
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getProtocolList(const QString &id,
                                              const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentProtocolIndex")]
      = IO::Drivers::Modbus::instance().protocolIndex();
  return CommandResponse::makeSuccess(id, result);
}
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getSerialPortList(const QString &id,
                                                const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getParityList(const QString &id,
                                            const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentParityIndex")]
      = IO::Drivers::Modbus::instance().parityIndex();
  return CommandResponse::makeSuccess(id, result);
}
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getDataBitsList(const QString &id,
                                              const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentDataBitsIndex")]
      = IO::Drivers::Modbus::instance().dataBitsIndex();
  return CommandResponse::makeSuccess(id, result);
}
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getStopBitsList(const QString &id,
                                              const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentStopBitsIndex")]
      = IO::Drivers::Modbus::instance().stopBitsIndex();
  return CommandResponse::makeSuccess(id, result);
}
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getBaudRateList(const QString &id,
                                              const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentBaudRate")]
      = IO::Drivers::Modbus::instance().baudRate();
  return CommandResponse::makeSuccess(id, result);
}
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getRegisterTypeList(const QString &id,
                                                  const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::ModbusHandler::getRegisterGroups(const QString &id,
                                                const QJsonObject &params)
{
  Q_UNUSED(params)

...
void API::Handlers::ConsoleHandler::registerCommands()
{
  ...
  registry.registerCommand(
      QStringLiteral("console.setEcho"),
      QStringLiteral("Enable/disable echo (params: enabled)"), &setEcho);

  registry.registerCommand(
      QStringLiteral("console.setShowTimestamp"),
  ...
  registry.registerCommand(
      ...
      QStringLiteral(
          "Set display mode (params: modeIndex: 0=PlainText, 1=Hex)"),
      &setDisplayMode);

  registry.registerCommand(
      QStringLiteral("console.setDataMode"),
      QStringLiteral("Set data mode (params: modeIndex: 0=UTF8, 1=Hex)"),
      &setDataMode);

  registry.registerCommand(
      QStringLiteral("console.setLineEnding"),
      QStringLiteral("Set line ending (params: endingIndex: 0=None, 1=LF, "
                     "2=CR, 3=CRLF)"),
      &setLineEnding);

  registry.registerCommand(
      QStringLiteral("console.setFontFamily"),
      QStringLiteral("Set font family (params: fontFamily)"), &setFontFamily);
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setEcho(const QString &id,
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setShowTimestamp(const QString &id,
                                                const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("enabled")))
  {
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setDisplayMode(const QString &id,
                                              const QJsonObject &params)
{
  ...
  result[QStringLiteral("modeName")] = (mode_index == 0)
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setDataMode(const QString &id,
                                           const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("modeIndex")))
  {
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setLineEnding(const QString &id,
                                             const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("endingIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: endingIndex"));
  }
  ...
  if (ending_index < 0 || ending_index > 3)
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("Invalid endingIndex: must be 0 (None), 1 (LF), 2 (CR), "
                       "or 3 (CRLF)"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setFontFamily(const QString &id,
                                             const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("fontFamily")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: fontFamily"));
  }

  const QString font_family
      = params.value(QStringLiteral("fontFamily")).toString();
  if (font_family.isEmpty())
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("fontFamily cannot be empty"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setFontSize(const QString &id,
                                           const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("fontSize")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: fontSize"));
  }
  ...
  if (font_size <= 0)
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("fontSize must be greater than 0"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::setChecksumMethod(const QString &id,
                                                 const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("methodIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: methodIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::clear(const QString &id,
                                     const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::send(const QString &id,
                                    const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::ConsoleHandler::getConfiguration(const QString &id,
                                                const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("displayMode")]
      = static_cast<int>(console.displayMode());

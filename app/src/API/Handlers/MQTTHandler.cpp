...
void API::Handlers::MQTTHandler::registerCommands()
{
  ...
  registry.registerCommand(
      ...
      QStringLiteral(
          "Set MQTT mode (params: modeIndex - 0=Publisher, 1=Subscriber)"),
      &setMode);

  registry.registerCommand(
      QStringLiteral("mqtt.setHostname"),
      QStringLiteral("Set MQTT broker hostname (params: hostname)"),
      &setHostname);

  registry.registerCommand(
      QStringLiteral("mqtt.setPort"),
      QStringLiteral("Set MQTT broker port (params: port)"), &setPort);

  registry.registerCommand(
      QStringLiteral("mqtt.setClientId"),
      QStringLiteral("Set MQTT client ID (params: clientId)"), &setClientId);

  registry.registerCommand(
      QStringLiteral("mqtt.setUsername"),
      QStringLiteral("Set MQTT username (params: username)"), &setUsername);

  registry.registerCommand(
      QStringLiteral("mqtt.setPassword"),
      QStringLiteral("Set MQTT password (params: password)"), &setPassword);

  registry.registerCommand(
      QStringLiteral("mqtt.setTopic"),
      QStringLiteral("Set MQTT topic filter (params: topic)"), &setTopic);

  registry.registerCommand(
      QStringLiteral("mqtt.setCleanSession"),
      QStringLiteral("Set clean session flag (params: enabled)"),
      &setCleanSession);

  registry.registerCommand(
      QStringLiteral("mqtt.setMqttVersion"),
      QStringLiteral("Set MQTT protocol version (params: versionIndex)"),
      &setMqttVersion);

  registry.registerCommand(
      QStringLiteral("mqtt.setKeepAlive"),
      QStringLiteral("Set keep-alive interval in seconds (params: seconds)"),
      &setKeepAlive);

  registry.registerCommand(
      QStringLiteral("mqtt.setAutoKeepAlive"),
      QStringLiteral("Set auto keep-alive (params: enabled)"),
      &setAutoKeepAlive);

  registry.registerCommand(
      QStringLiteral("mqtt.setWillQoS"),
      QStringLiteral("Set will message QoS (params: qos - 0, 1, or 2)"),
      &setWillQoS);

  registry.registerCommand(
      QStringLiteral("mqtt.setWillRetain"),
      QStringLiteral("Set will message retain flag (params: enabled)"),
      &setWillRetain);

  registry.registerCommand(
      QStringLiteral("mqtt.setWillTopic"),
      QStringLiteral("Set will message topic (params: topic)"), &setWillTopic);

  registry.registerCommand(
      QStringLiteral("mqtt.setWillMessage"),
      QStringLiteral("Set will message payload (params: message)"),
      &setWillMessage);

  registry.registerCommand(
      QStringLiteral("mqtt.setSslEnabled"),
      QStringLiteral("Enable/disable SSL (params: enabled)"), &setSslEnabled);

  registry.registerCommand(
      QStringLiteral("mqtt.setSslProtocol"),
      QStringLiteral("Set SSL protocol (params: protocolIndex)"),
      &setSslProtocol);

  registry.registerCommand(
      QStringLiteral("mqtt.setPeerVerifyMode"),
      QStringLiteral("Set peer verification mode (params: modeIndex)"),
      &setPeerVerifyMode);

  registry.registerCommand(
      QStringLiteral("mqtt.setPeerVerifyDepth"),
      QStringLiteral("Set peer verification depth (params: depth)"),
      &setPeerVerifyDepth);

  registry.registerCommand(QStringLiteral("mqtt.connect"),
                           QStringLiteral("Open MQTT connection"), &connect);
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setMode(const QString &id,
                                    const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("modeIndex")))
  {
    return CommandResponse::makeError(
        ...
        QStringLiteral("Missing required parameter: modeIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setHostname(const QString &id,
                                        const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("hostname")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: hostname"));
  }
  ...
  if (hostname.isEmpty())
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("Hostname cannot be empty"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setPort(const QString &id,
                                    const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("port")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: port"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setClientId(const QString &id,
                                        const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("clientId")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: clientId"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setUsername(const QString &id,
                                        const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("username")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: username"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setPassword(const QString &id,
                                        const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("password")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: password"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setTopic(const QString &id,
                                     const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("topic")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: topic"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setCleanSession(const QString &id,
                                            const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setMqttVersion(const QString &id,
                                           const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("versionIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: versionIndex"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setKeepAlive(const QString &id,
                                         const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("seconds")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: seconds"));
  }
  ...
  if (seconds < 0)
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("Keep-alive seconds must be non-negative"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setAutoKeepAlive(const QString &id,
                                             const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("enabled")))
  {
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setWillQoS(const QString &id,
                                       const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("qos")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: qos"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setWillRetain(const QString &id,
                                          const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("enabled")))
  {
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setWillTopic(const QString &id,
                                         const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("topic")))
  {
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setWillMessage(const QString &id,
                                           const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setSslEnabled(const QString &id,
                                          const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("enabled")))
  {
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setSslProtocol(const QString &id,
                                           const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("protocolIndex")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: protocolIndex"));
  }

  const int protocolIndex
      = params.value(QStringLiteral("protocolIndex")).toInt();
  auto &mqtt = MQTT::Client::instance();
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setPeerVerifyMode(const QString &id,
                                              const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("modeIndex")))
  {
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::setPeerVerifyDepth(const QString &id,
                                               const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("depth")))
  {
    return CommandResponse::makeError(
        id, ErrorCode::MissingParam,
        QStringLiteral("Missing required parameter: depth"));
  }
  ...
  if (depth < 0)
  {
    return CommandResponse::makeError(
        id, ErrorCode::InvalidParam,
        QStringLiteral("Peer verify depth must be non-negative"));
  }
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::connect(const QString &id,
                                    const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::disconnect(const QString &id,
                                       const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::toggleConnection(const QString &id,
                                             const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::regenerateClientId(const QString &id,
                                               const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::getConfiguration(const QString &id,
                                             const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  if (mqtt.sslProtocol() < sslProtocols.count())
    result[QStringLiteral("sslProtocolName")]
        = sslProtocols.at(mqtt.sslProtocol());
  ...
  if (mqtt.peerVerifyMode() < verifyModes.count())
    result[QStringLiteral("peerVerifyModeName")]
        = verifyModes.at(mqtt.peerVerifyMode());
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::getConnectionStatus(const QString &id,
                                                const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::getModes(const QString &id,
                                     const QJsonObject &params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::getMqttVersions(const QString &id,
                                            const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentVersionIndex")]
      = MQTT::Client::instance().mqttVersion();
  return CommandResponse::makeSuccess(id, result);
}
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::getSslProtocols(const QString &id,
                                            const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentProtocolIndex")]
      = MQTT::Client::instance().sslProtocol();
  return CommandResponse::makeSuccess(id, result);
}
 ...
 */
API::CommandResponse
API::Handlers::MQTTHandler::getPeerVerifyModes(const QString &id,
                                               const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  result[QStringLiteral("currentModeIndex")]
      = MQTT::Client::instance().peerVerifyMode();
  return CommandResponse::makeSuccess(id, result);
}

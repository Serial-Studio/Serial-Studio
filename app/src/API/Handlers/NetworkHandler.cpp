...
void API::Handlers::NetworkHandler::registerCommands()
{
  ...
  registry.registerCommand(
      QStringLiteral("io.driver.network.setRemoteAddress"),
  ...
  registry.registerCommand(
      QStringLiteral("io.driver.network.setUdpMulticast"),
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::setRemoteAddress(const QString &id,
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::setTcpPort(const QString &id,
                                          const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::setUdpLocalPort(const QString &id,
                                               const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("port")))
  {
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::setUdpRemotePort(const QString &id,
                                                const QJsonObject &params)
{
  if (!params.contains(QStringLiteral("port")))
  {
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::setSocketType(const QString &id,
                                             const QJsonObject &params)
{
  ...
  const int socketTypeIndex
      = params.value(QStringLiteral("socketTypeIndex")).toInt();
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::setUdpMulticast(const QString &id,
                                               const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::lookup(const QString &id,
                                      const QJsonObject &params)
{
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::getConfiguration(const QString &id,
                                                const QJsonObject &params)
{
  Q_UNUSED(params)
  ...
  if (network.socketTypeIndex() < socketTypes.count())
    result[QStringLiteral("socketTypeName")]
        = socketTypes.at(network.socketTypeIndex());
  ...
  result[QStringLiteral("defaultUdpRemotePort")]
      = network.defaultUdpRemotePort();
 ...
 */
API::CommandResponse
API::Handlers::NetworkHandler::getSocketTypes(const QString &id,
                                              const QJsonObject &params)
{
  Q_UNUSED(params)

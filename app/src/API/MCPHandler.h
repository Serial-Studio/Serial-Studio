...
private:
  ...
  MCP::MCPResponse handleInitialize(const MCP::MCPRequest &request,
                                    const QString &sessionId);
  MCP::MCPResponse handlePing(const MCP::MCPRequest &request);
  MCP::MCPResponse handleToolsList(const MCP::MCPRequest &request);
  MCP::MCPResponse handleToolsCall(const MCP::MCPRequest &request,
                                   const QString &sessionId);
  ...
  QJsonObject commandToToolSchema(const QString &name,

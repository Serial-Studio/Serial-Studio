...
The shared-table API is injected here too. A table inside folders is addressed
...
variables per frame, resolve handles once at load with `tableHandle` and use

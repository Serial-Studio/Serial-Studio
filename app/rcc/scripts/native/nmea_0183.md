...
Each frame is a fixed 16-value row; only channels 1-8 are ever written.
Channels 9-16 are unused and always read back empty.
...
| 8 | Track (degrees) | RMC, VTG |
| 9-16 | Unused (always empty) | - |

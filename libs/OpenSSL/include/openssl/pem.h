...
#define PEM_write_ex_fnsig(name, type, OUTTYPE, writename)                                         \
    int PEM_##writename##_##name##_ex(OUTTYPE *out, const type *x, OSSL_LIB_CTX *libctx,           \
                                      const char *propq)
...
#    define IMPLEMENT_PEM_write_fp(name, type, str, asn1)                                          \
        ...
        {                                                                                          \
            return PEM_ASN1_write((i2d_of_void *)i2d_##asn1, str, out, x, NULL, NULL, 0, NULL,     \
                                  NULL);                                                           \
        }
...
#define IMPLEMENT_PEM_write_bio(name, type, str, asn1)                                             \
    ...
    {                                                                                              \
        return PEM_ASN1_write_bio((i2d_of_void *)i2d_##asn1, str, out, x, NULL, NULL, 0, NULL,     \
                                  NULL);                                                           \
    }
...
int PEM_read_bio_ex(BIO *bp, char **name, char **header, unsigned char **data, long *len,
                    unsigned int flags);
...
DECLARE_PEM_rw(X509, X509) DECLARE_PEM_rw(X509_AUX, X509) DECLARE_PEM_rw(X509_REQ, X509_REQ)
    DECLARE_PEM_write(X509_REQ_NEW, X509_REQ) DECLARE_PEM_rw(X509_CRL, X509_CRL) DECLARE_PEM_rw(
        X509_PUBKEY, X509_PUBKEY) DECLARE_PEM_rw(PKCS7,
                                                 PKCS7) DECLARE_PEM_rw(NETSCAPE_CERT_SEQUENCE,
...
#    ifndef OPENSSL_NO_DSA
                    DECLARE_PEM_rw_cb_attr(OSSL_DEPRECATEDIN_3_0, DSAPrivateKey, DSA)
                        DECLARE_PEM_rw_attr(OSSL_DEPRECATEDIN_3_0, DSA_PUBKEY,
                                            DSA) DECLARE_PEM_rw_attr(OSSL_DEPRECATEDIN_3_0,
                                                                     DSAparams, DSA)
#    endif
#endif
...
#    ifndef OPENSSL_NO_DEPRECATED_3_0
                                        DECLARE_PEM_rw_attr(OSSL_DEPRECATEDIN_3_0, DHparams, DH)
                                            DECLARE_PEM_write_attr(OSSL_DEPRECATEDIN_3_0, DHxparams,
                                                                   DH)
#    endif
#endif

...
#define sk_ASN1_OBJECT_new_reserve(cmp, n)                                                         \
    ((STACK_OF(ASN1_OBJECT) *)OPENSSL_sk_new_reserve(ossl_check_ASN1_OBJECT_compfunc_type(cmp),    \
                                                     (n)))
...
#define sk_ASN1_OBJECT_deep_copy(sk, copyfunc, freefunc)                                           \
    ((STACK_OF(ASN1_OBJECT) *)OPENSSL_sk_deep_copy(                                                \
        ossl_check_const_ASN1_OBJECT_sk_type(sk), ossl_check_ASN1_OBJECT_copyfunc_type(copyfunc),  \
        ossl_check_ASN1_OBJECT_freefunc_type(freefunc)))
...
#define sk_ASN1_INTEGER_new_reserve(cmp, n)                                                        \
    ((STACK_OF(ASN1_INTEGER) *)OPENSSL_sk_new_reserve(ossl_check_ASN1_INTEGER_compfunc_type(cmp),  \
                                                      (n)))
...
#define sk_ASN1_INTEGER_find_all(sk, ptr, pnum)                                                    \
    OPENSSL_sk_find_all(ossl_check_ASN1_INTEGER_sk_type(sk), ossl_check_ASN1_INTEGER_type(ptr),    \
                        pnum)
...
#define sk_ASN1_INTEGER_set_cmp_func(sk, cmp)                                                      \
    ((sk_ASN1_INTEGER_compfunc)OPENSSL_sk_set_cmp_func(                                            \
        ossl_check_ASN1_INTEGER_sk_type(sk), ossl_check_ASN1_INTEGER_compfunc_type(cmp)))
...
int ASN1_item_verify_ex(const ASN1_ITEM *it, const X509_ALGOR *alg,
                        ...
                        const ASN1_OCTET_STRING *id, EVP_PKEY *pkey, OSSL_LIB_CTX *libctx,
                        const char *propq);
...
void *ASN1_item_d2i_fp_ex(const ASN1_ITEM *it, FILE *in, void *x, OSSL_LIB_CTX *libctx,
                          const char *propq);
...
void *ASN1_item_d2i_bio_ex(const ASN1_ITEM *it, BIO *in, void *pval, OSSL_LIB_CTX *libctx,
                           const char *propq);
...
int ASN1_item_print(BIO *out, const ASN1_VALUE *ifld, int indent, const ASN1_ITEM *it,

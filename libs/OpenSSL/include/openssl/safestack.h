...
#define SKM_DEFINE_STACK_OF_INTERNAL(t1, t2, t3)                                                   \
    ...
    static ossl_unused ossl_inline const OPENSSL_STACK *ossl_check_const_##t1##_sk_type(           \
...
#define sk_OPENSSL_STRING_insert(sk, ptr, idx)                                                     \
    OPENSSL_sk_insert(ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_type(ptr),  \
                      (idx))
...
#define sk_OPENSSL_STRING_set_cmp_func(sk, cmp)                                                    \
    ((sk_OPENSSL_STRING_compfunc)OPENSSL_sk_set_cmp_func(                                          \
        ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_compfunc_type(cmp)))
...
#    define sk_OPENSSL_BLOCK_set_cmp_func(sk, cmp)                                                 \
        ((sk_OPENSSL_BLOCK_compfunc)OPENSSL_sk_set_cmp_func(                                       \
            ossl_check_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_compfunc_type(cmp)))

...
OSSL_DEPRECATEDIN_3_0 long BIO_debug_callback(BIO *bio, int cmd, const char *argp, int argi,
                                              long argl, long ret);
#endif
...
#define sk_BIO_deep_copy(sk, copyfunc, freefunc)                                                   \
    ((STACK_OF(BIO) *)OPENSSL_sk_deep_copy(ossl_check_const_BIO_sk_type(sk),                       \
                                           ossl_check_BIO_copyfunc_type(copyfunc),                 \
                                           ossl_check_BIO_freefunc_type(freefunc)))
#define sk_BIO_set_cmp_func(sk, cmp)                                                               \
    ((sk_BIO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_BIO_sk_type(sk),                          \
                                              ossl_check_BIO_compfunc_type(cmp)))
...
__owur int BIO_recvmmsg(BIO *b, BIO_MSG *msg, size_t stride, size_t num_msg, uint64_t flags,
                        size_t *msgs_processed);
int BIO_gets(BIO *bp, char *buf, int size);
int BIO_get_line(BIO *bio, char *buf, int size);
int BIO_write(BIO *b, const void *data, int dlen);
int BIO_write_ex(BIO *b, const void *data, size_t dlen, size_t *written);
__owur int BIO_sendmmsg(BIO *b, BIO_MSG *msg, size_t stride, size_t num_msg, uint64_t flags,
                        size_t *msgs_processed);
...
int BIO_ADDR_rawmake(BIO_ADDR *ap, int family, const void *where, size_t wherelen,
                     unsigned short port);
...
int (*BIO_meth_get_sendmmsg(const BIO_METHOD *biom))(BIO *, BIO_MSG *, size_t, size_t, uint64_t,
                                                     size_t *);
...
int BIO_meth_set_recvmmsg(BIO_METHOD *biom,
                          int (*f)(BIO *, BIO_MSG *, size_t, size_t, uint64_t, size_t *));
int (*BIO_meth_get_recvmmsg(const BIO_METHOD *biom))(BIO *, BIO_MSG *, size_t, size_t, uint64_t,
                                                     size_t *);

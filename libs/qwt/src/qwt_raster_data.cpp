...
public:
  ...
  inline bool intersect(const QwtPoint3D vertex[3], QPointF line[2],
...
inline bool QwtRasterData::ContourPlane::intersect(const QwtPoint3D vertex[3],
                                                   QPointF line[2],
                                                   bool ignoreOnPlane) const
{
  bool found = true;
...
inline QPointF
QwtRasterData::ContourPlane::intersection(const QwtPoint3D &p1,
                                          const QwtPoint3D &p2) const
{
...
QwtRasterData::contourLines(const QRectF &rect, const QSize &raster,

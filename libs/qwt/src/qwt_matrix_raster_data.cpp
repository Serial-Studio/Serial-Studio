...
static inline double qwtHermiteInterpolate(double A, double B, double C,
                                           double D, double t)
{
  const double t2 = t * t;
...
static inline double qwtBicubicInterpolate(double v00, double v10, double v20,
                                           double v30, double v01, double v11,
                                           double v21, double v31, double v02,
                                           double v12, double v22, double v32,
                                           double v03, double v13, double v23,
                                           double v33, double dx, double dy)
{
...
QRectF QwtMatrixRasterData::pixelHint(const QRectF &area) const
{
  ...
  if (m_data->resampleMode == NearestNeighbour)
  {
    ...
    {
      rect = QRectF(intervalX.minValue(), intervalY.minValue(), m_data->dx,
                    m_data->dy);
    }
  }
...
double QwtMatrixRasterData::value(double x, double y) const
{
  ...
  switch (m_data->resampleMode)
  {
    case BicubicInterpolation: {
      ...
      value = qwtBicubicInterpolate(v00, v10, v20, v30, v01, v11, v21, v31, v02,
                                    v12, v22, v32, v03, v13, v23, v33,

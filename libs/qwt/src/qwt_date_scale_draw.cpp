 ...
 */
QString
QwtDateScaleDraw::dateFormatOfDate(const QDateTime &dateTime,
...
QwtDateScaleDraw::intervalType(const QwtScaleDiv &scaleDiv) const
{
  ...
  for (int i = 0; i < ticks.size(); i++)
  {
    ...
    {
      const QDateTime dt0
          = QwtDate::floor(dt, static_cast<QwtDate::IntervalType>(j));

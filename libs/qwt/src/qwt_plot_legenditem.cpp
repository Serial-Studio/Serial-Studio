...
LayoutItem::LayoutItem(const QwtPlotLegendItem *legendItem,
 ...
 */
void QwtPlotLegendItem::draw(QPainter *painter, const QwtScaleMap &xMap,
                             ...
                             const QRectF &canvasRect) const
{
  ...
  for (int i = 0; i < m_data->layout->count(); i++)
  {
    const QwtPlotLegendItemPrivate::LayoutItem *layoutItem
        = static_cast<QwtPlotLegendItemPrivate::LayoutItem *>(
    ...
    drawLegendData(painter, layoutItem->plotItem(), layoutItem->data(),
                   layoutItem->geometry());
                                     ...
                                     const QList<QwtLegendData> &data)
{
  ...
  QMap<const QwtPlotItem *,
       QList<QwtPlotLegendItemPrivate::LayoutItem *>>::const_iterator it
 ...
 */
QList<QRect>
QwtPlotLegendItem::legendGeometries(const QwtPlotItem *plotItem) const
{
  QList<QwtPlotLegendItemPrivate::LayoutItem *> layoutItems;

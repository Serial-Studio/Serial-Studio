...
" SS_GLIBC_HAS_FORTIFY3)
      ...
      # fails to authenticate PACIASP-signed return addresses during unwinding. The LuaJIT
      # error path (spec 0051) unwinds externally on macOS, so the hazard class persists;
      # the gate stays as-is deliberately — re-enabling pac-ret on Apple is a separate,
      # measured hardening change, not a rider on the runtime swap. Apple's supported
      # pointer-auth ABI is arm64e, which distributed apps cannot target; keep branch
      # protection for non-Apple ARM only.
